  ...
  useEffect(() => {
    (async () => {
      AsyncStorage.getItem('defaultCourt', async (error, result) => {
        ...
        await props.storePlayground(res[0],res[1],res[2],res[3],res[4],res[5])
...
const mapDispachToProps = dispatch => {
  return {
    storePlayground: (name,id,lat,lon,img,description) => dispatch({ type: "STORE_PLAYGROUND", value: name,value1: id, value2:lat,value3:lon,value4:img,value5:description, value6:id}),
