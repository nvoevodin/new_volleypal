  ...
  return (
    <React.Fragment>
      ...
      <HomeAccordion
        playground={[
          {
            title: props.reducer.eventInfo["event_name"],
            content: props.reducer.eventInfo["description"],
          },
        ]}
      />
      <View style={styles.container}>
        <MainEvent
          id={props.reducer.eventInfo["admin_id"]}
          invited={props.reducer.eventInfo["invited"]}
          waiting={props.reducer.eventInfo["waiting"]}
        />
      </View>
...
export default connect(mapStateToProps, mapDispachToProps)(EventView);
