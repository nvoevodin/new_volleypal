...
<Text style= {{fontSize:13}}>{country} | {city} | {type} </Text>
...
<ListItem>
<Left><CountryPicker countries1 = {countries} SendCountryFromPicker = {ReceiveCountryFromPicker}/></Left>
<Text>Country</Text>
</ListItem>
<ListItem>
<Left><CityPicker cities1 = {cities} SendCityFromPicker = {ReceiveCityFromPicker}/></Left>
<Text>City</Text>
</ListItem>
<ListItem>
...
<Button style ={{width: '90%'}} full
rounded
primary onPress = {() => filterCourts()}>
                       <Text>Filter</Text>
                       </Button>
                       </ListItem>:null}
</>:null
