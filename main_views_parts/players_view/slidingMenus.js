    ...
    return (
      <View>
        ...
        <Tabs tabBarUnderlineStyle={{backgroundColor:'grey'}}>
          <Tab tabStyle ={{backgroundColor: 'white'}} activeTextStyle={{color: 'grey', fontWeight: 'bold', fontSize:16}} activeTabStyle={{backgroundColor: 'white'}} textStyle={{color: 'grey', fontWeight: 'normal'}} heading="Playing Now">
       <CheckInList numberOfChecks = {numberOfChecks} />
          </Tab>
          <Tab tabStyle ={{backgroundColor: 'white'}} activeTextStyle={{color: 'grey', fontWeight: 'bold', fontSize:16}} activeTabStyle={{backgroundColor: 'white'}} textStyle={{color: 'grey', fontWeight: 'normal'}} heading="Coming to Play">
