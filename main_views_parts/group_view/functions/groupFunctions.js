export const getMembers = (id) =>{
    ...
    .then((res) => {
      ...
      const data = fetch(`${global.x}/get_users/${res.data[0]["JSON_EXTRACT(members, '$')"]}`)
      .then((res) => res.json())
      .then((res) => {
  ...
  export const getWaitlist = (id) =>{
    ...
    .then((res) => {
      ...
      var waiting = fetch(`${global.x}/get_users/${res.data[0]["JSON_EXTRACT(waiting, '$')"]}`)
      .then((res) => res.json())
      .then((res) => {
  ...
  export const getInvited = (id) =>{
    ...
    .then((res) => {
      ...
      var invited = fetch(`${global.x}/get_users/${res.data[0]["JSON_EXTRACT(invited, '$')"]}`)
      .then((res) => res.json())
      .then((res) => {
